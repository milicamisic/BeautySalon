...
public class AddReceptionistWindow extends JDialog {
	...
	public AddReceptionistWindow(ReceptionistCRUDWindow parent) {
		super(parent, true);
		...
		addButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(inputValid) 
				{
					...
					managerService.addReceptionist(receptionist);
	...
	private boolean valideFields(String name, String surname, String phoneNumber, String address, String username, String password, String basePayString, String educationLevelString, String serviceYearsString)
	{
		...
		JOptionPane.showMessageDialog(null, "Receptionist added!", "Information message", JOptionPane.INFORMATION_MESSAGE);
		return true;
