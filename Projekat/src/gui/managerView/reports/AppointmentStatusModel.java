...
public class AppointmentStatusModel extends AbstractTableModel{
	
	private static final long serialVersionUID = 7480224552092106397L;
	
	private String[] columns = {"Status", "Number Of Appointments"};
	
	private ManagerService managerService;
	
	ArrayList<Object[]> tableContents;

	public AppointmentStatusModel(LocalDate startDate, LocalDate endDate)
	{
		managerService = new ManagerService();
		tableContents = managerService.getAppointmentStatusReport(startDate, endDate);
	}
