...
public class ModifyAppointmentWindow extends JDialog {
	...
	private static final long serialVersionUID = 5522356680218771624L;
	...
	public ModifyAppointmentWindow(ViewAppointmentsWindow parent, int rowIndex) {
		super(parent, true);
		...
		modifyButton.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				...
				if(inputValid) 
				{
					...
					int result = receptionistService.modifyAppointment(appointment);
