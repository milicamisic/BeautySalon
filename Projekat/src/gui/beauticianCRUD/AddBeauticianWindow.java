...
public class AddBeauticianWindow extends JDialog {
	...
	public AddBeauticianWindow(BeauticianCRUDWindow parent) {
		super(parent, true);
		...
		addButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(inputValid) 
				{
					...
					managerService.addBeautician(beautician);
		...
		addButton.setBounds(928, 534, 156, 51);
